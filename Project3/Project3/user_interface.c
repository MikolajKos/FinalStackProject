...
//Usun¹³em mo¿liwoœæ wyboru typu CAR, stos jest uniwersalny dostosowany do przyjmowania wartoœci dowolnego typu
...
//Funkcjê odpowiedzialn¹ za inicjalizacjê stosu implementujê w stack.c, a nastêpnie wywo³ujê j¹ w odpowiednich miejscach,
